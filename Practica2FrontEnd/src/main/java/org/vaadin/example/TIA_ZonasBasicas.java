...
public class TIA_ZonasBasicas {
    ...
    public TIA_ZonasBasicas(int id, String codigo_geometria, String zona_basica_salud, Float tasa_incidencia_acumulada_ultimos_14dias, Float tasa_incidencia_acumulada_total, int casos_confirmados_totales, int casos_confirmados_ultimos_14dias, Date fecha_informe) {
        this.id = id;
    ...
    public String getTodo() {
        ...
        return "Id: " + id + "\n" +
                "Codigo geometria: " + codigo_geometria + "\n" +
